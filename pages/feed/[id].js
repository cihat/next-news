...
/* const onDropdownSelected = (e) => {
  console.log("THE COUNTRY: ", e.target.value)
} */
    ...
    <Layout>
      <div className={styles.main}>
        {/*  <div className="selectCountry">
          <label htmlFor="countries">Lütfen Bir Ülke Seçiniz: </label>
          <select name="countries" id="countries" onChange={onDropdownSelected}>
...
export const getServerSideProps = async (pageContext) => {
  ...
  const apiResponse = await fetch(
    `https://newsapi.org/v2/top-headlines?country=${country || 'tr'}&pageSize=5&page=${pageNumber}`,
    {
      headers: {
